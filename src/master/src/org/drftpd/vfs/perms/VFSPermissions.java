...
public class VFSPermissions {
	...
	public void loadExtensions() {
		...
		/*
		 * <extension-point id="VFSPerm"> <parameter-def id="Class" /> <parameter-def
		 * id="Method" /> <parameter-def id="Type" /> <parameter-def id="Directive" />
		 * <parameter-def id="Priority" /> </extension-point>
		 */

		try {
			List<PluginObjectContainer<VFSPermHandler>> loadedHandlers = CommonPluginUtils.getPluginObjectsInContainer(
					this, "master", "VFSPerm", "Class", "Method", new Class[] { String.class, StringTokenizer.class });
	...
	private boolean verifyType(String type) {
		...
		return type.equals("upload") || type.equals("makedir") || type.equals("delete") || type.equals("deleteown")
				|| type.startsWith("rename") || type.equals("renameown") || type.equals("privpath")
	...
	public boolean checkPathPermission(String type, User user, InodeHandle inode, boolean defaults,
		...
		if (order == null) {
			NullPointerException npe = new NullPointerException(
					"You've got some screwy plugin.xml files!  Blame fr0w!");
